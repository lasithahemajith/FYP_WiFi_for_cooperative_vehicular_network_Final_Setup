...
const ITransmission *Ieee80211ScalarTransmitter::createTransmission(const IRadio *transmitter, const cPacket *macFrame, simtime_t startTime) const
{
    ...
    EV<<transmissionBitrate<<modulation<<"Krishan"<<endl;
    ...
    EV<<"%%%%%%%%%%%%%%%Preamable duration:"<< preambleDuration<<"Header duration :"<<headerDuration<< "Data duration :"<<dataDuration<< "whole duration :"<<preambleDuration+headerDuration+dataDuration<<endl;
